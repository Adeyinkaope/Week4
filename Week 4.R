...
# See which years are included  ## range returns the min and maxi values of a numeric vector the highest value and loswest value
range(exped$YEAR, na.rm = TRUE) #na.rm removes missing values during calculations
unique(exped$YEAR) ## give all the years in the data set
## $bis a seprateor which whichs a particular column in a table like  in this i want the year in the exped table dataset and##
## r will omly look at the year and give that to me
## i am telling R to check something in the year of the exped table .
...
### to count how many time the year appeared in the exped dataset
...
expeditions_per_year <- table(exped$YEAR) ## this will create a table from the count year and give it the name
